import ProjectConfigFile,Utitilities,TestCases, SMTUtilities,CDMOptimizationTest,CDMOptimizationTestThreshold
from z3 import *
import time
...
def select_security_controls(security_control_list,threat_action_list,threat_action_name_to_id,risk_threat_action,asset_enterprise_list,threat_list,threat_name_to_id,affordable_risk,budget):
    ...
    return CDMOptimizationTestThreshold.SMT_Environment(security_control_list, selected_security_controls, threat_action_name_list,
