...
def readResultFile(asset_number_index,risk_elimination):
    recommendedCDM = []
    readFile = open('%s_%s_%s_%s.txt'%(ProjectConfigFile.RESULT_OUTPUT_FILE_NAME,asset_number_index,
                                       ProjectConfigFile.OUTPUT_RESULT_FILE_INDEX,risk_elimination),'r+')
